...
export default function Card() {
    ...
    const sendData = () => {
        axios.post("https://fuad-final-default-rtdb.firebaseio.com/storecardds.json", {name, card,image:password, id:Date.now()})
            .then(res => {
                console.log(res)
                setName('')
                setCard('')
    ...
    <div className="nav">
        <h1 class="Name">Vegefoods</h1>
            <ul>
                ...
                <li  className="this"><Link to="/card">Card</Link></li>
        ...
        <div className="home">
            <div className="input-box">
                <h2>Write HomeCards</h2>
                <h4>Write Title</h4>
                <input value={name} placeholder="Write Title..." onChange={e => (setName(e.target.value))} />
                <h4>Write Text</h4>
                <input value={card} placeholder="Write Text..." onChange={e => (setCard(e.target.value))}/>
                <h4>Image</h4>
