...
export default function Fruits() {
    ...
    const sendData = () => {
        axios.post("https://fuad-final-default-rtdb.firebaseio.com/fruit.json", {name, card,image:password, id:Date.now()})
            .then(res => {
                console.log(res)
                setName('')
                setCard('')
    ...
    <div className="nav">
        <h1 class="Name">Vegefoods</h1>
            <ul>
                ...
                <li className="this"><Link to="/fruits">Fruits</Link></li>
