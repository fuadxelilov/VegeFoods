...
export default function Vegetable() {
    ...
    const sendData = () => {
        axios.post("https://fuad-final-default-rtdb.firebaseio.com/vegetable.json", {name, card,image:password, id:Date.now()})
            .then(res => {
                console.log(res)
                setName('')
                setCard('')
    ...
    <div className="nav">
        <h1 class="Name">Vegefoods</h1>
            <ul>
                ...
                <li className="this"><Link to="/vegetable">Vegetable</Link></li>
        ...
        <div className="home">
            <div className="input-box">
                <h2 className="header2">Write Vegetables</h2>
                <h4>Write Title</h4>
