...
export default function Wishlist() {
    ...
    const sendData = () => {
        axios.post("https://fuad-final-default-rtdb.firebaseio.com/wishlist.json", {text, content,text2,image:password, id:Date.now()})
            .then(res => {
                console.log(res)
                setText('')
                setText2('')
    ...
    <div className="nav">
        <h1 class="Name">Vegefoods</h1>
            <ul>
                ...
                <li className="this"><Link to="/wishlist">Wishlist</Link></li>
