...
var eee = document.getElementById('number');
let count = 0;
  function cot(){
  count+= Number(eee.value);
  ...
  function card4() {
  document.getElementById('imagechange').src="./../Assets/Image/Kələm.webp";
  var heading= document.querySelector(".heading");
  heading.innerHTML = "<h3>Cabbage</h3>";
  var number = document.querySelector('.link_number');
  number.innerHTML= "<a>5.0</a>";
  var price = document.querySelector(".price");
  price.innerHTML = "<span>$20.00</span>";
  var rating= document.querySelector(".second");
  rating.innerHTML = "70 <span>Rating</span>";
  var sold = document.querySelector(".third");
  sold.innerHTML = "700 <span>Sold</span>";
  var kg = document.querySelector(".kq_part");
  kg.innerHTML= "500 kg available";
  var click = document.querySelector(".click");
  var click = document.querySelector(".click");

  } 
  function card3() {
  document.getElementById('imagechange').src="./../Assets/Image/Lobya.webp";
  var heading= document.querySelector(".heading");
  heading.innerHTML = "<h3>Green Beans</h3>";
  var number = document.querySelector('.link_number');
  number.innerHTML= "<a>2.0</a>";
  var price = document.querySelector(".price");
  price.innerHTML = "<span>$50.00</span>";
  var rating= document.querySelector(".second");
  rating.innerHTML = "20 <span>Rating</span>";
  var sold = document.querySelector(".third");
  sold.innerHTML = "200 <span>Sold</span>";
  var kg = document.querySelector(".kq_part");
  kg.innerHTML= "400 kg available";
  }
  function card2() {
  document.getElementById('imagechange').src="./../Assets/Image/Çiyələklər.webp";
  var heading= document.querySelector(".heading");
  heading.innerHTML = "<h3>Strawberry</h3>";
  var number = document.querySelector('.link_number');
  number.innerHTML= "<a>3.0</a>";
  var price = document.querySelector(".price");
  price.innerHTML = "<span>$60.00</span>";
  var rating= document.querySelector(".second");
  rating.innerHTML = "30 <span>Rating</span>";
  var sold = document.querySelector(".third");
  sold.innerHTML = "300 <span>Sold</span>";
  var kg = document.querySelector(".kq_part");
  kg.innerHTML= "200 kg available";
  }
  function card() {
  document.getElementById('imagechange').src="./../Assets/Image/Bibər.webp";
  var headingDiv       = document.querySelector(".price");
  headingDiv.innerHTML = "<span>$80.00</span>";
...
// APPEAR 
  const backgroundd = document.querySelectorAll(".container");
  const section_first =   document.querySelectorAll(".background");
  const addcart = document.querySelectorAll('.addcart');
  const heading = document.querySelectorAll(".headings");
  const storecards = document.querySelectorAll(".store_cards")
  ...
  const footer = document.querySelectorAll(".fourth_list");
const Appearoptions = {
    threshold:0
};
...
backgroundd.forEach(backgroundd2=>{
    apperOnScroll.observe(backgroundd2)
})
addcart.forEach(addcart2=>{
  apperOnScroll.observe(addcart2)
})
heading.forEach(headingg=>{
  apperOnScroll.observe(headingg)
})
storecards.forEach(storecard=>{
  apperOnScroll.observe(storecard)
})
